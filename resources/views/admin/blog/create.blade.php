    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            <div class="flex items-center gap-1.5 text-xxs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-1.5">
                ...
                <span>&rsaquo;</span>
                <span class="text-[#008060] font-extrabold">New Article</span>
            </div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">New Article</h1>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Write and publish a new blog article.</p>
        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-250 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="art-title" required class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors" placeholder="Enter article title...">
                        </div>
                        <div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-250 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="art-meta-title" class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors" placeholder="SEO meta title...">
                        </div>
                        <div>
