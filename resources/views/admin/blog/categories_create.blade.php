...
<div class="w-full">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add Blog Category</h1>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Create a new category to organise blog articles.</p>
        </div>
    ...
    <div class="max-w-2xl">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-250 dark:border-gray-700 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/80">
                <h2 class="text-sm font-bold text-gray-900 dark:text-white">Add Blog Category</h2>
            </div>
            ...
            <form onsubmit="handleSave(event, false)" class="p-6 space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <p class="text-xxs text-gray-400 dark:text-gray-500 mt-1">
                        Slug: <span id="slug-preview" class="font-mono text-gray-500 dark:text-gray-400">—</span>
                    </p>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <button type="button" onclick="handleSave(event, true)" class="px-5 py-2.5 text-sm font-semibold text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-750 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md border border-gray-300 dark:border-gray-650 transition-colors cursor-pointer">
                        Save and go back to list
                    </button>
                    <a href="/admin/blog/categories" class="px-5 py-2.5 text-sm font-semibold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer">
                        Cancel
                    </a>
                </div>
