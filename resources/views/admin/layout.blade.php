        ...
        <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
            ...
            <div class="space-y-1">
                <button type="button" onclick="toggleSidebarDropdown('training-courses-menu', 'training-courses-arrow')"
                    class="w-full flex items-center justify-between px-3 py-1.5 {{ Request::is('admin/courses*') ? 'bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700' }} rounded-md font-medium text-sm transition-colors duration-200 focus:outline-none">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 {{ Request::is('admin/courses*') ? 'text-gray-600 dark:text-gray-300' : 'text-gray-500 dark:text-gray-400' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <svg id="training-courses-arrow"
                        class="w-4 h-4 transform transition-transform duration-200 {{ Request::is('admin/courses*') ? 'rotate-90' : '' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </button>
                <div id="training-courses-menu"
                    class="{{ Request::is('admin/courses*') ? '' : 'hidden' }} pl-8 space-y-1">
                    <a href="/admin/courses"
                        class="flex items-center px-3 py-1.5 {{ Request::is('admin/courses') && !Request::is('admin/courses/popular') && !Request::is('admin/courses/create') ? 'bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-white font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700' }} rounded-md font-medium text-xs transition-colors duration-200">
