...
<div class="w-full pb-12">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Venue</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Modify the global training course venue details, descriptions, images, and SEO configuration</p>
        </div>
    </div>
                    ...
                    <div class="p-5 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="venue-name" required value="{{ $venue->venue_name }}" placeholder="e.g. Athens" class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors" oninput="clearError('name')">
                            ...
                            <div>
                                ...
                                <input type="text" id="flag-name" required value="{{ $venue->flag_image }}" placeholder="e.g. Greece" class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors" oninput="clearError('flag')">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="venue-region" required class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors appearance-none cursor-pointer" onchange="clearError('region')">
                                    ...
                                    <option value="Europe" {{ $venue->region_name === 'Europe' ? 'selected' : '' }}>Europe</option>
                                    <option value="Middle East" {{ $venue->region_name === 'Middle East' ? 'selected' : '' }}>Middle East</option>
                                    <option value="Rest of World" {{ $venue->region_name === 'Rest of World' ? 'selected' : '' }}>Rest of World</option>
                                </select>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-700 shadow-sm transition-colors overflow-hidden">
                    ...
                    <div class="p-5 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="editor-description" name="description">{!! e($venue->venue_text) !!}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="editor-featured-text" name="featured-text">{!! e($venue->venue_featured_text) !!}</textarea>
                        </div>
                    ...
                    <div class="p-4 space-y-2.5">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="venue-status" required class="w-full text-xs bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#008060]">
                                ...
                                <option value="0" {{ $venue->status == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="border border-dashed border-gray-300 dark:border-gray-600 hover:border-emerald-500 dark:hover:border-emerald-500 rounded-lg p-4 text-center cursor-pointer transition-colors" onclick="triggerFileInput('file-banner')">
                                ...
                                <span class="block mt-1 text-[10px] text-gray-400 dark:text-gray-500" id="preview-banner">
                                    @if($venue->banner_image)
                                        {{ basename($venue->banner_image) }}
                                    @else
                                        No file selected
                                    @endif
                                </span>
...
<script>
    ...
    async function saveVenueData(shouldRedirect) {
        ...
        try {
            const response = await fetch(`/admin/courses/venues/${venueId}`, {
                method: 'POST', // Use POST with _method = PUT for FormData/file upload support
