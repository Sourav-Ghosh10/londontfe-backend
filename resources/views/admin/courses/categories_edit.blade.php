                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-700 shadow-sm transition-colors overflow-hidden">
                    ...
                    <div class="p-5 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="editor-tagline" name="tagline">{!! e($category->category_tag_line) !!}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="editor-content" name="content">{!! e($category->category_content) !!}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="editor-about" name="about">{!! e($category->category_txt) !!}</textarea>
                        </div>
