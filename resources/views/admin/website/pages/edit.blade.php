    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            <div class="flex items-center gap-1.5 text-xxs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-1.5">
                ...
                <span>&rsaquo;</span>
                <span class="text-[#008060] font-extrabold">Edit Page Content</span>
            </div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Page Content</h1>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Modify the details of an existing content page.</p>
        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-250 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="page-title" value="{{ $page->title }}" required placeholder="e.g. Bespoke Learning"
                        ...
                        <div>
                            ...
                            <textarea id="page-content-editor">{!! e($page->content) !!}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="menu-title" value="{{ $page->menu_title }}" placeholder="e.g. Bespoke Courses"
                                    class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors">
                            </div>
                            <div>
                                ...
                                <input type="text" id="page-url" value="{{ $page->url }}" required placeholder="e.g. learning-solutions/bespoke-learning"
                                    class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors">
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="page-status" class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] appearance-none cursor-pointer">
                                    <option value="Active" {{ $page->status === '1' ? 'selected' : '' }}>Active</option>
                                    <option value="Inactive" {{ $page->status === '0' ? 'selected' : '' }}>Inactive</option>
                                </select>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-250 dark:border-gray-700 p-6">
                    ...
                    <div id="banner-drop" onclick="document.getElementById('page-banner').click()"
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Click to upload new image</p>
                    </div>
                    <input type="file" id="page-banner" accept="image/*" class="hidden" onchange="previewImage(this)">
                    <img id="banner-preview" class="mt-3 w-full rounded-lg object-contain max-h-32 bg-gray-50 dark:bg-gray-700 p-2 {{ $page->banner_url ? '' : 'hidden' }}" src="{{ $page->banner_url ?? '' }}" alt="Banner Preview">
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-250 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                            ...
                            <div class="relative">
                                <select id="parent-page" class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] appearance-none cursor-pointer">
                                    ...
                                    @foreach($parentPages as $p)
                                        <option value="{{ $p->id }}" {{ $page->parent_page_id == $p->id ? 'selected' : '' }}>{{ $p->title }}</option>
                                    @endforeach
                                </select>
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3.5 text-gray-500">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        ...
                        <div>
                            ...
                            <input type="text" id="seo-title" value="{{ $seo->title ?? '' }}" required placeholder="e.g. What is Bespoke Learning?"
                                class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="meta-desc" required rows="4" placeholder="Discover Bespoke Learning solutions..."
                                class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors">{{ $seo->meta_description ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function handleSave(e) {
        ...
        fetch('/admin/website/pages/{{ $page->id }}', {
            method: 'POST',
            headers: {
