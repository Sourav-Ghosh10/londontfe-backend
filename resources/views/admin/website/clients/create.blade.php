    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            <div class="flex items-center gap-1.5 text-xxs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-1.5">
                ...
                <span>&rsaquo;</span>
                <span class="text-[#008060] font-extrabold">Add Client</span>
            </div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add Client</h1>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Upload a new client logo to display on the website.</p>
        </div>
    ...
    <form onsubmit="handleSave(event)">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-250 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="alt-text" required placeholder="e.g. petronas icon"
                        ...
                        <div>
                            ...
                            <input type="number" id="client-order" min="1" placeholder="e.g. 1"
                                class="w-full text-sm bg-[#f6f6f7] dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded-md px-3.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#008060] focus:border-[#008060] transition-colors">
                        </div>
            ...
            <div class="space-y-6">
                ...
                <!-- Client Logo Upload -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xs border border-gray-250 dark:border-gray-700 p-6">
                    <h2 class="text-sm font-bold text-gray-900 dark:text-white mb-1">Client Logo <span class="text-red-500">*</span></h2>
                    <p class="text-xxs text-gray-400 dark:text-gray-500 mb-3">Upload the client's logo image</p>
                    ...
                    <img id="logo-preview" class="hidden mt-3 w-full rounded-lg object-contain max-h-32 bg-gray-50 dark:bg-gray-700 p-2" src="" alt="Logo Preview">
                </div>
